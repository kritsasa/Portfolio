        ...
        <div>
          ...
          <div className="flex space-x-4 mt-25">
            <div className="flex flex-col">
              ...
              <h6 className="text-lightGray text-md font-inter-tight">Nickname:</h6>
              <h6 className="text-lightGray text-md font-inter-tight">Date of brith:</h6>
              <h6 className="text-lightGray text-md font-inter-tight">Address:</h6>
              <h6 className="text-lightGray text-md font-inter-tight">Email:</h6>
              <h6 className="text-lightGray text-md font-inter-tight">Phone:</h6>
            </div>
            <div className="flex flex-col">
              <p className="text-gray-500 text-md font-inter-tight">Kritsada Mooljam</p>
              <p className="text-gray-500 text-md font-inter-tight">P</p>
              <p className="text-gray-500 text-md font-inter-tight">September 19, 2006</p>
              <p className="text-gray-500 text-md font-inter-tight">Chiang Saen, Chiang Rai 57150 Thailand</p>
              <p className="text-gray-500 text-md font-inter-tight">ninep9p2006@gmail.com</p>
              <p className="text-gray-500 text-md font-inter-tight">0885578023</p>
            </div>
          </div>
        </div>
      </div>
